#script que solicite a digitação dos elementos (números inteiros) de duas matrizes 3 x 3 e gere uma terceira matriz onde cada elemento é o maior valor de cada posição das duas matrizes lidas.
